...
const chalkStub = Object.create(chalk, {
  yellow: {
    value(str) { return chalk.yellow(str); },
    writable: true,
  },
  red: {
    value(str) { return chalk.red(str); },
    writable: true,
  },
  green: {
    value(str) { return chalk.green(str); },
    writable: true,
  },
  // underline: {
...
chalkStub.green.bold = chalk.green.bold;

const formatter = proxyquire('../index.js', { chalk: chalkStub });

describe('formatter:stylish-verbose', () => {
  let sandbox;
  ...
  beforeEach(() => {
    ...
    sandbox.spy(chalkStub.green, 'bold');
  });
  ...
  describe('when passed a single error message', () => {
    ...
    it('should return a string in the correct format', () => {
      ...
      assert.strictEqual(chalkStub.green.bold.callCount, 0);
    });
  ...
  describe('when passed one file not found message', () => {
    const code = [{
      ...
      errorCount: 1,
      warningCount: 0,
      messages: [{ fatal: true, message: "Couldn't find foo.js." }],
    }];
  ...
  describe('fixable problems', () => {
    ...
    it('should output fixable problems message when warnings are fixable', () => {
      const code = [{
        ...
        messages: [{ message: 'Unexpected foo.' }],
      }];
    ...
    it('should output the total number of fixable errors and warnings', () => {
      const code = [{
        ...
        messages: [{ message: 'Unexpected bar.' }],
      }];
