...
// See below for how to make the call in geth. (ValueIncrementer3.increment.sendTransaction(3,9, {from:eth.coinbase,gas:1000000});)
// note that we needed more than the (geth) default gas of 90k this time. I chose 1 mil. (unused gas is refunded anyway)

contract ValueIncrementer3 {
	...
	// call this in geth like so: > ValueIncrementer3.increment.sendTransaction(3, 8, {from:eth.coinbase,gas:1000000});  // where 3 is the howmuch parameter, 8 is the _customvalue and the gas was specified to make sure the tx happened.
...
> ValueIncrementer3.increment.sendTransaction(3,9, {from:eth.coinbase});
"0x7731880bef6e5122aead43a1e60ffda7fad0508013a8045c9c256da78fb769b2"
> ValueIncrementer3.getIteration();
0
> ValueIncrementer3.getWhatHappened();
"constructor executed"
> var tx = ValueIncrementer3.increment.sendTransaction(4,19, {from:eth.coinbase});
undefined
> tx
...
> ValueIncrementer3.getWhatHappened();
"constructor executed"
> ValueIncrementer3.increment.sendTransaction(3,9, {from:eth.coinbase,gas:10000000});
...
> ValueIncrementer3.increment.sendTransaction(3,9, {from:eth.coinbase,gas:1000000});
...
> ValueIncrementer3.getCustomValue();
9
> {nsole.log(e, contract);endTransaction(3,8, {from:eth.coinbase});
    console.log('Contract mined! address: ' + contract.address + ' transactionHash: ' + contract.transactionHash);
> ValueIncrementer3.kill.sendTransaction({from: eth.coinbase});
...
> ValueIncrementer3.increment.sendTransaction(13,19, {from:eth.coinbase,gas:25000});
