...
contract ValueIncrementer2 {

    address creator;
    int iteration;
    string whathappened;

    function ValueIncrementer2() 
    {
        creator = msg.sender; 								
        iteration = 0;
	...
	// call this in geth like so: > ValueIncrementer2.increment.sendTransaction(3, {from:eth.coinbase});  // where 3 is the howmuch parameter
...
> ValueIncrementer2.increment.sendTransaction(3, {from:eth.coinbase});
"0x9cbceb6f5c3819322f48d0f01d111ac4b6223a2427447e857f493084da886ce5"
> ValueIncrementer2.getWhatHappened();
"constructor executed"
> ValueIncrementer2.getWhatHappened();
"howmuch was nonzero. Incremented by its value."
> ValueIncrementer2.getIteration();
3
> ValueIncrementer2.increment.sendTransaction(-7, {from:eth.coinbase});
"0x4e251eb394e2ba82536cbbb2ab88b9b7da94ffccd106bb3051394cbcc8280f66"
> ValueIncrementer2.getIteration();
-4
> ValueIncrementer2.increment.sendTransaction({from:eth.coinbase});
...
> ValueIncrementer2.increment.sendTransaction(.0004, {from:eth.coinbase});
