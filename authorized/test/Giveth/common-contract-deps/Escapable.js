...
const TestPayableEscapable = artifacts.require("../contracts/Giveth/common-contract-deps/test/TestPayableEscapable.sol");
const TestToken = artifacts.require("../contracts/Giveth/common-contract-deps/test/TestToken.sol");
